                    ...
                    with st.spinner(f'🔄 Generando versión de {dpi_valor} DPI (puede tardar unos minutos)...'):
                        try:
                            ...
                            if img_hires:
                                ...
                                st.image(thumb, caption="Vista previa de alta resolución", width=400)
                                
                                # Descarga de alta resolución
                                filename_hires = f"mural_HIRES_{stats_rect['paleta']}_{ancho_mural}x{alto_mural}cm.png"
